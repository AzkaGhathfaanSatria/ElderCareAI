export default function ElderlyLoading() {
  return (
    <div className="min-h-screen bg-paper">
      <div className="flex">
        {/* Sidebar Skeleton */}
        <aside className="hidden h-screen w-64 shrink-0 animate-pulse bg-sidebar lg:flex lg:flex-col">
          {/* Logo */}
          <div className="border-b border-sidebar-soft px-5 py-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-sidebar-soft" />

              <div className="space-y-2">
                <div className="h-3 w-24 rounded bg-sidebar-soft" />
                <div className="h-2 w-28 rounded bg-sidebar-soft" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 p-4">
            <div className="h-4 w-20 rounded bg-sidebar-soft" />

            <div className="h-11 rounded-xl bg-sidebar-soft" />
            <div className="h-11 rounded-xl bg-sidebar-soft" />
            <div className="h-11 rounded-xl bg-sidebar-soft" />
            <div className="h-11 rounded-xl bg-sidebar-soft" />
          </div>
          ...
          {/* Admin */}
          <div className="mt-auto border-t border-sidebar-soft p-4">
            <div className="flex items-center gap-3 rounded-xl bg-sidebar-soft p-3">
              <div className="h-8 w-8 rounded-full bg-sidebar-soft" />
        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="animate-pulse p-4 sm:p-6 lg:p-8">
            ...
            {/* Elderly Profile */}
            <section className="mb-6 rounded-xl bg-surface p-5 sm:p-6">
            ...
            <section className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-2">
              ...
              <div className="rounded-xl bg-surface p-5 sm:p-6">
                ...
                <div className="mt-5 space-y-4">
                  <div className="h-14 rounded-lg bg-border" />
                  <div className="h-14 rounded-lg bg-border" />
                  <div className="h-14 rounded-lg bg-border" />
                </div>
              </div>
