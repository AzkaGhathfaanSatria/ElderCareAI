// Skeleton bersama untuk /admin, /admin/users, dan /admin/devices — ketiga
// halaman ini punya kerangka layout identik, jadi loading-state-nya juga
// sama persis. Diekstrak ke sini supaya tidak triplikasi di 3 file loading.tsx.
